...
void* GalogenGetProcAddress(const char *name) {
  ...
  if( ptr ) {
      //printf( "success: loading OpenGL function: %s\n", name );
  } else {
      printf( "fail: loading OpenGL function: %s\n", name );
  }
  assert( ptr );
  return ptr;
}
...
static void  GL_APIENTRY _impl_glShaderSource (GLuint shader, GLsizei count, const GLchar ** string, const GLint * length) {
